            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="images/IMG-20191016-WA0020.jpg" alt="..." class="img-circle profile_img">
                    </div>
                    <div class="profile_info">
                        <span>Welcome,</span>

                        <h2>Pramod Mohanty</h2>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <!-- /menu profile quick info -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="images/IMG-20191016-WA0020.jpg" alt="">Pramod
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="#" class="dropdown-toggle info-number" data-toggle="dropdown"
                               aria-expanded="false">
                                ...
                                <span class="badge bg-green" onclick="window.location='message_librarian.php';"><?php echo $tot;?></span>
                            </a>
