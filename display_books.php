                        ...
                        <div class="x_panel">
                            ...
                            <form name="form1" action="" method="post">
                             ...
                             {    $res=mysqli_query($link,"select * from add_books where books_name like('$_POST[t1]%')");
                                ...
                                echo "<th>";echo "avialability quantity";echo "</th>";
                                echo "</tr>";
                                while($row=mysqli_fetch_array($res))
                                {
                                   echo "<tr>";
                                   echo "<td>";echo $row["books_name"];echo "</td>";
                                   echo "<td>"; ?> <img alt="hii" src="<?php echo $row["books_image"];?>"height="40" width="30"> <?php echo "</td>";
...
echo "<td>"; ?> <a class="btn btn-default" style="background-color:red;color:black" href="delete.php?id=<?php echo $row["id"]; ?>">Delete Book</a><?php echo "</td>";                              
